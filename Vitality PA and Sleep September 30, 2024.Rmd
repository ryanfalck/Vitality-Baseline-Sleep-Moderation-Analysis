...
lmm.ex2.mdl<- function(y,cov1,cov2,cov3,cov4){
  ...
  return(list(summary=modelsummary, lsmeans=means.1, group_contrasts=contrasts, contrasts_ci.95=conf.95, post_hoc_contrasts = post.hoc, 
...
# 8) Additional Reviewer requested analyses not included in the manuscript 
...
## 8.1.1) Results for subjective sleep quality including CHAMPS PA as a covariate
...
## 8.1.2) Results for objective sleep efficiency including CHAMPS PA as a covariate
...
## 8.1.3) Results for objective sleep duration including CHAMPS PA as a covariate
...
## 8.2) Linear mixed model for comparing outcomes based on subjective sleep duration (Good sleep duration = 420-490 minutes/night)
